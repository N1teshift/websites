...
import { useTranslationNamespace } from './TranslationNamespaceContext';
import { TFunction, TOptions, i18n as I18nInstanceType } from 'i18next';
...
export function useFallbackTranslation(namespaces?: string | string[]): FallbackTranslationResponse { 
    ...
    const tWithFallback = ((key: string | string[], tOptions?: TOptions) => {
        ...
        let translation: string = primaryT(key, tOptions) as string;

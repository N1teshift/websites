...
const SuccessMessage: React.FC<SuccessMessageProps> = ({ messageKey, visible }) => {
    ...
    return (
        <div
            className={`fixed top-4 right-4 max-w-sm w-full p-4 rounded-md bg-green-600 text-white text-lg shadow-lg transition-transform duration-500 ease-in-out z-[1000] ${isVisible ? 'translate-x-0' : 'translate-x-[150%]'
                }`}
        >

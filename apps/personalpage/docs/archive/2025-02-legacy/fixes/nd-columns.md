...
// After
getUniqueAssessments(students, ['summative', 'homework', 'homework_graded', 'homework_reflection', 'test'])
```
...
*All homework columns (ND1-ND6) are now correctly configured and displaying as expected.*

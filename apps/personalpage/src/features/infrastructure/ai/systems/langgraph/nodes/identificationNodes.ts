 ...
 */
export async function identify_object_type(state: GraphStateType, _config?: RunnableConfig): Promise<Partial<GraphStateType>> {
 ...
 */
export async function start_settings_extraction(state: GraphStateType): Promise<Partial<GraphStateType>> {

...
// Also, ensure this component is exported from its parent index.ts if that is how GenericTable.tsx imports it.
// For now, assuming direct import or it will be added to an index.ts later. 

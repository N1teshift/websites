...
export interface TestSettings {
  ...
  settings: CoefficientSettings | ExpressionSettings | EquationSettings | CoefficientsSettings | TermSettings | TermsSettings | FunctionSettings | PointSettings | SetSettings | IntervalSettings | InequalitySettings;
}
...
function validateCoefficientSettings(
  ...
  if (testSettings.numberSet !== undefined) {
    const numberSetError = validateNumberSet(
      testSettings.numberSet, 
      responseSettings.numberSet
    );
  ...
  if (testSettings.rules !== undefined) {
    const rulesError = validateRules(
      testSettings.rules, 
      responseSettings.rules
    );
...
function validateTermSettings(
  ...
  if (testSettings.termIds !== undefined) {
    ...
    const termIdsError = validateStringArray(
      testTermIds,
      responseTermIds,
      'termIds'
    );

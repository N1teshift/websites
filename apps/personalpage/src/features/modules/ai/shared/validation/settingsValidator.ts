 ...
 */
const CoefficientSettingsSchema: z.ZodType<CoefficientSettings> = z
  .object({
 ...
 */
const CoefficientsSettingsSchema: z.ZodType<CoefficientsSettings> = z
  .object({
    coefficients: z
      .array(CoefficientSettingsSchema)
      .default([])
      .transform((val) => val ?? []),
 ...
 */
const TermSettingsSchema: z.ZodType<TermSettings> = z
  .object({
 ...
 * Validates that power is exactly [number, number].
 */
const TermsSettingsSchema: z.ZodType<TermsSettings> = z
  .object({
 ...
 * Validates that power is exactly [number, number].
 */
const ExpressionSettingsSchema: z.ZodType<ExpressionSettings> = z.lazy(() =>
  z
    .object({
      expressions: z.array(
        z.union([TermSettingsSchema, TermsSettingsSchema, ExpressionSettingsSchema])
      ),
      combinationType: z.enum([
        "addition",
        "subtraction",
 ...
 */
const EquationSettingsSchema: z.ZodType<EquationSettings> = z
  .object({
    terms: z.union([
 ...
 */
const InequalitySettingsSchema: z.ZodType<InequalitySettings> = z
  .object({
    terms: z.union([
      z.tuple([ExpressionSettingsSchema]),
      z.tuple([ExpressionSettingsSchema, ExpressionSettingsSchema]),
 ...
 */
const FunctionSettingsSchema: z.ZodType<FunctionSettings> = z
  .object({
 ...
 */
const PointSettingsSchema: z.ZodType<PointSettings> = z
  .object({
    coefficients: CoefficientsSettingsSchema,
    name: z.enum([
      "A",
 ...
 */
const SetSettingsSchema: z.ZodType<SetSettings> = z
  .object({
    coefficients: CoefficientsSettingsSchema,
    name: z.enum([
      "A",
 ...
 */
const IntervalSettingsSchema: z.ZodType<IntervalSettings> = z
  .object({
    coefficients: CoefficientsSettingsSchema,
 ...
 */
export function validateObjectSettings(
  settings: unknown,

...
export const termSettingsSchema = {
  ...
  properties: {
    ...
    subObjectPromptParts: {
      type: "array",
      description:
        "Specific parts of the user prompt that describe the coefficients collection and it's individual coefficients.",
      items: {
        type: "string",
        description:
          "A phrase or sentence from the user prompt pertaining to the coefficients collection and it's individual coefficients.",
      },
    },
  },

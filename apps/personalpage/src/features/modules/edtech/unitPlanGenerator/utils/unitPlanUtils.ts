...
export const getDefaultUnitPlanData = (): UnitPlanData => ({
    ...
    unitTitle: '2025–2026 m.m. UNIT PLAN',
    unitContent: '',
    ...
    conceptualUnderstandings: 'How does logic show that two things or systems in math are the same, equal, equivalent?',
    ...
    inquiryStatement: 'How does logic show that two things or systems in math are the same, equal, equivalent?',
    factualQuestions: [
    ...
    individualContext: 'Understanding how number systems and logical reasoning help us make personal decisions about money, time, and data.',
    localContext: '',
    globalContextLens: 'Exploring how systems of logic and equivalence (standard form, irrational numbers) are used in global scientific innovations such as space exploration or climate modeling.',
    atlSkills: ['draw-conclusions', 'interpret-data'],
    atlStrategies: '1. Use comparison strategies to analyze patterns between exponential and linear growth\n2. Use graphic organizers (tables, double number lines) to justify mathematical equivalence\n3. Learn how to record data systematically',
    atlCards: [],
    learningExperienceCards: [],
...
const getDefaultSubunits = (): SubunitData[] => [
    {
        ...
        conceptualKnowledge: [],
        proceduralKnowledge: [],
        successCriteria: ['Students distinguish between rational and irrational numbers and identify their characteristics'],
        activities: 'Sort rational vs. irrational numbers in groups; discuss examples',
        learningExperiences: 'Compare and contrast activity, student-generated examples, use of diagrams and visuals',
        differentiation: 'Provide glossary for EAL learners; color-coded number sets for visual learners.',
        summativeAssessment: '',
        interimAssessment: '',
        formativeAssessment: ''
    },
    {
        ...
        learningExperiences: 'Concept journaling to record patterns and reflect on number systems; use Frayer model to define roots.',
        differentiation: 'Scaffolded examples; tiered root challenges; visual support for abstract reasoning.',
        summativeAssessment: '',
        interimAssessment: '',
        formativeAssessment: ''
    },
    {
        ...
        learningExperiences: 'Students generate inquiry questions using concepts like scale and magnitude; Simulations (distances in space) for real-world context.',
        differentiation: 'Number line scaffold; pairing for peer support; adjusted questions for readiness.',
        summativeAssessment: '',
        interimAssessment: '',
        formativeAssessment: ''
    },
    {
        ...
        learningExperiences: 'Case study on real-world science problems; Visualizing the concepts using infographics to represent scale.',
    ...
    },
    {
        ...
        learningExperiences: 'Concept-led inquiry where students ask "Why do these laws work?" and compare/contrast exponent rules.',
        differentiation: 'Choice boards for level of challenge; color-coded exponent tables; peer explanation.',
        summativeAssessment: '',
        interimAssessment: '',
        formativeAssessment: ''
    },
    {
        ...
        learningExperiences: 'Concept mapping of all exponent rules learned; students write a one-sentence summary to describe logic of equivalence.',
        differentiation: 'Flexible grouping; scaffolding steps for rule application; sentence starters for reflection.',
        summativeAssessment: '',
        interimAssessment: '',
        formativeAssessment: ''
    }

...
export const ATL_CARD_CATEGORIES: ATLCardCategory[] = [
  // Communication
  {
    value: "Communication/Communication through language",
    label: "Communication/Communication through language",
  },
  {
    value: "Communication/Communication through social media",
    label: "Communication/Communication through social media",
  },
  {
    value:
  ...
  // Social
  {
    value: "Social/Developing positive interpersonal relationships and collaboration skills",
    label: "Social/Developing positive interpersonal relationships and collaboration skills",
  },
  {
    value: "Social/Developing social intelligence to make connections",
    label: "Social/Developing social intelligence to make connections",
  },
];

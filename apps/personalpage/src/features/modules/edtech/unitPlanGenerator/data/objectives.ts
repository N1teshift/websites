...
export const OBJECTIVES: Objective[] = [
    ...
    },
    {
        ...
        detailedDescription: 'Investigating patterns allows students to experience the excitement and satisfaction of mathematical discovery. Working through investigations encourages students to become risk-takers, inquirers and critical thinkers. The ability to inquire is invaluable in the MYP and contributes to lifelong learning.',
        strands: [
            {
                id: 'i',
                objectiveId: 'B',
                fullId: 'B-i',
                description: 'Select and apply mathematical problem-solving techniques to discover complex patterns'
            },
            {
                id: 'ii',
                objectiveId: 'B',
        ...
        assessmentNotes: 'Tasks that are too guided (not allowing students to select problem-solving techniques) should result in a maximum achievement level of 6 (years 1-2) or 4 (year 3+). For year 3+, students describing general rules consistent with incorrect findings can achieve up to level 6 if the rule is of equivalent complexity.'
    },
    {
        id: 'C',
        name: 'C - Communicating',
        description: 'Communicating in mathematics',
        detailedDescription: 'Mathematics provides a powerful and universal language. Students are expected to use appropriate mathematical language and different forms of representation when communicating mathematical ideas, reasoning and findings, both orally and in writing.',
        strands: [
            {
                id: 'i',
                objectiveId: 'C',
                fullId: 'C-i',
                description: 'Use appropriate mathematical language (notation, symbols and terminology) in both oral and written explanations'
            },
            {
                id: 'ii',
                objectiveId: 'C',
    ...
    },
    {
        ...
        strands: [
            ...
            },
            {
                ...
                objectiveId: 'D',
                fullId: 'D-ii',
                description: 'Select appropriate mathematical strategies when solving authentic real-life situations'
            },
            {
                id: 'iii',
                objectiveId: 'D',
            ...
            },
            {
                ...
                objectiveId: 'D',
                fullId: 'D-v',
                description: 'Justify whether a solution makes sense in the context of the authentic real-life situation'
            }
        ],
        keyLearningExpectations: [
...
export const getStrandById = (objectiveId: string, strandId: string): ObjectiveStrand | undefined => {
    const objective = getObjectiveById(objectiveId);
...
export const getObjectiveSummary = (objectiveId: string): string => {
    ...
    return `${objective.description}\n\nKey expectations:\n${objective.keyLearningExpectations.slice(0, 2).map(exp => `• ${exp}`).join('\n')}`;
};

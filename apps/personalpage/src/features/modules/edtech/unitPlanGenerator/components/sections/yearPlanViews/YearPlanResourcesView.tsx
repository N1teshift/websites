...
const YearPlanResourcesView: React.FC<YearPlanResourcesViewProps> = ({ unitPlans }) => {
    ...
    const totalUniqueResources = printedResources.length + digitalResources.length + guestsResources.length;
    ...
    const formatUnitList = (units: ResourceUsage['units']): string => {
        ...
        return sortedUnits
            .map(u => u.order ? `Unit ${u.order}` : u.title)
            .join(', ');
    };
        ...
        <div className="space-y-6 p-6">
            <div>
                ...
                <p className="text-text-secondary mb-6">
                    A consolidated view of all resources used across your unit plans. 
                    Resources are deduplicated and show which units use them.
                </p>
            </div>
            ...
            <div className="bg-surface-card border-2 border-border-default rounded-lg p-6">
                <div className="flex items-center justify-between">
                    ...
                    <div className="text-center">
                        <h4 className="text-sm font-semibold text-text-secondary uppercase tracking-wide">Unique Resources</h4>
                        <p className="text-2xl font-bold text-brand mt-1">
                            {totalUniqueResources}
                        </p>
                    </div>
                    <div className="text-right">
                        <h4 className="text-sm font-semibold text-text-secondary uppercase tracking-wide">Resource Types</h4>

...
import { UnitPlanData, UnitPlanDocument, SubunitData, ActiveSection, QuestionType, AssessmentTask, ATLCard, ActivityCard, LearningExperienceCard, CurriculumConnection } from '../types/UnitPlanTypes';
...
interface SectionContentProps {
    ...
    updateSubunit: (subunitIndex: number, field: keyof SubunitData, value: string | number | string[]) => void;
    addSubunit: () => void;
    ...
    updateSubunitByPlanId: (planId: string, subunitIndex: number, field: keyof SubunitData, value: string | number | string[]) => void;
    ...
    updateReflectionByPlanId: (planId: string, field: 'reflectionPriorToTeaching' | 'reflectionDuringTeaching' | 'reflectionAfterTeaching' | 'reflectionFuturePlanning', value: string) => void;
}
...
const SectionContent: React.FC<SectionContentProps> = React.memo(({
    ...
    const alwaysAvailableSections: ActiveSection[] = ['guide', 'settings', 'data-management', 'preview'];
    
    // Sections that have Year Plan View implementations
    const yearPlanImplementedSections: ActiveSection[] = ['content', 'community-engagement', 'reflection', 'resources'];

                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-xs text-blue-700">
                        {curriculumModule.units.length}{" "}
                        {curriculumModule.units.length === 1 ? "unit" : "units"}
                      </span>
                    </div>
                    <h4 className="text-base font-bold text-blue-900">{curriculumModule.name}</h4>
                  </div>
                  <svg
                  ...
                  <div className="border-t-2 border-blue-200 bg-white">
                    <div className="p-3 space-y-2">
                      {curriculumModule.units.map((unit) => {
                        ...
                        return (
                          <div key={unit.id} className="border border-blue-200 rounded bg-blue-50">
                            {/* Unit Header */}
                            <button
                            ...
                            >
                              <div className="flex-1">
                                <div className="flex items-center gap-2 mb-1">
                                  <span className="text-xs font-semibold text-blue-700">Unit</span>
                                  <span className="text-xs text-blue-600">
                                    {unit.subunits.length} subunits
                                  </span>
                                </div>
                                <p className="text-sm font-semibold text-blue-900">{unit.name}</p>
                              </div>
                              <svg
              ...
              >
                ...
                >
                  <div className="flex-1">
                    ...
                    <h4 className="text-base font-bold text-green-900">{bookModule.name}</h4>
                    {bookModule.description && (
                      <p className="text-xs text-green-700 mt-1">{bookModule.description}</p>
                    )}
                  </div>
                  <svg
                    className={`w-5 h-5 flex-shrink-0 ml-2 transition-transform ${
                            ...
                            >
                              <div className="flex-1">
                                <div className="flex items-center gap-2 mb-1">
                                  ...
                                  <span className="text-xs text-green-600">pp. {unit.pages}</span>
                                </div>
                                <p className="text-sm font-semibold text-green-900">{unit.title}</p>
                                    ...
                                    >
                                      <div className="flex items-start gap-2">
                                        ...
                                        <div className="flex-1">
                                          ...
                                          {subsection.objectiveIds &&
                                            subsection.objectiveIds.length > 0 && (

    ...
    switch (context) {
      ...
      case "Orientation in Space and Time":
        return {
          ...
          description:
            "Students will explore personal histories; homes and journeys; turning points for humankind; discoveries; explorations and migrations of humankind; the relationships between, and the interconnectedness of, individuals and civilizations, from personal, local and global perspectives.",
          examples: [

...
const SubunitCard: React.FC<SubunitCardProps> = ({
  ...
  const addPriorKnowledgeItem = (
    field: "priorKnowledgeSubjectSpecific" | "priorKnowledgeLearningSkills"
  ) => {
    const currentList = Array.isArray(subunit[field]) ? subunit[field] : [];
    onUpdate(field, [...currentList, ""]);
  };

  const updatePriorKnowledgeItem = (
    field: "priorKnowledgeSubjectSpecific" | "priorKnowledgeLearningSkills",
    index: number,
    value: string
  ) => {
  ...
  const removePriorKnowledgeItem = (
    field: "priorKnowledgeSubjectSpecific" | "priorKnowledgeLearningSkills",
    index: number
  ) => {
    const currentList = Array.isArray(subunit[field]) ? subunit[field] : [];
  ...
  const addNewKnowledgeItem = (
    field: "topicsTerminology" | "conceptualKnowledge" | "proceduralKnowledge"
  ) => {
    const currentList = Array.isArray(subunit[field]) ? subunit[field] : [];
    onUpdate(field, [...currentList, ""]);
  };

  const updateNewKnowledgeItem = (
    field: "topicsTerminology" | "conceptualKnowledge" | "proceduralKnowledge",
    index: number,
    value: string
  ) => {
  ...
  const countKnowledgeFields = () => {
    let filled = 0;
    const total = 5;
    const priorSubject = Array.isArray(subunit.priorKnowledgeSubjectSpecific)
      ? subunit.priorKnowledgeSubjectSpecific
      : [];
    const priorSkills = Array.isArray(subunit.priorKnowledgeLearningSkills)
      ? subunit.priorKnowledgeLearningSkills
      : [];
    const topics = Array.isArray(subunit.topicsTerminology) ? subunit.topicsTerminology : [];
    const conceptual = Array.isArray(subunit.conceptualKnowledge)
      ? subunit.conceptualKnowledge
      : [];
    const procedural = Array.isArray(subunit.proceduralKnowledge)
      ? subunit.proceduralKnowledge
      : [];
          ...
          <div className="mb-4">
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <h4 className="text-md font-semibold text-white">ℹ️ {t("basic_information")}</h4>
              ...
              <div className="mt-2 p-4 bg-surface-card rounded-lg border-2 border-border-default">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <FormField
                    ...
                    subunitContext={{
                      subunitIndex: subunitIndex || 0,
                      subunitNumber: subunit.subunitNumber,
                    }}
                  />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          {(Array.isArray(subunit.priorKnowledgeSubjectSpecific)
                            ? subunit.priorKnowledgeSubjectSpecific
                            : []
                          ).map((item, index) => (
                            <div key={index} className="flex items-start space-x-2">
                              ...
                              <IconButton
                                icon={<FiTrash2 size={16} />}
                                onClick={() =>
                                  removePriorKnowledgeItem("priorKnowledgeSubjectSpecific", index)
                                }
                                color="red"
                                size="medium"
                                title={t("remove")}
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          {(Array.isArray(subunit.priorKnowledgeLearningSkills)
                            ? subunit.priorKnowledgeLearningSkills
                            : []
                          ).map((item, index) => (
                            <div key={index} className="flex items-start space-x-2">
                              ...
                              <IconButton
                                icon={<FiTrash2 size={16} />}
                                onClick={() =>
                                  removePriorKnowledgeItem("priorKnowledgeLearningSkills", index)
                                }
                                color="red"
                                size="medium"
                                title={t("remove")}
                  ...
                  <div className="p-4 bg-surface-card rounded-lg border-2 border-border-default">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          {(Array.isArray(subunit.topicsTerminology)
                            ? subunit.topicsTerminology
                            : []
                          ).map((item, index) => (
                            <div key={index} className="flex items-start space-x-2">
                              <textarea
                                value={item}
                                onChange={(e) =>
                                  updateNewKnowledgeItem("topicsTerminology", index, e.target.value)
                                }
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          {(Array.isArray(subunit.conceptualKnowledge)
                            ? subunit.conceptualKnowledge
                            : []
                          ).map((item, index) => (
                            <div key={index} className="flex items-start space-x-2">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          {(Array.isArray(subunit.proceduralKnowledge)
                            ? subunit.proceduralKnowledge
                            : []
                          ).map((item, index) => (
                            <div key={index} className="flex items-start space-x-2">
          ...
          <div className="my-6">
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <h4 className="text-md font-semibold text-white">✅ {t("success_criteria")}</h4>
            ...
            {isSuccessCriteriaExpanded && (
              <div className="mt-2 p-4 bg-surface-card rounded-lg border-2 border-border-default">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    {(Array.isArray(subunit.successCriteria) ? subunit.successCriteria : []).map(
                      (item, index) => (
                        <div key={index} className="flex items-start space-x-2">
                          <textarea
                            value={item}
          ...
          <div className="my-6">
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <h4 className="text-md font-semibold text-white">🎯 {t("learning_activities")}</h4>

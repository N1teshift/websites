        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-4 rounded-lg border-l-4" style={previewStyles.secondaryBlock}>
                    <h4 className="font-semibold mb-3" style={previewStyles.fieldLabel}>Prior to teaching the unit</h4>
                ...
                <div className="p-4 rounded-lg border-l-4" style={previewStyles.secondaryBlock}>
                    <h4 className="font-semibold mb-3" style={previewStyles.fieldLabel}>During teaching</h4>
                    <div className="text-text-secondary">
                ...
                <div className="p-4 rounded-lg border-l-4" style={previewStyles.secondaryBlock}>
                    <h4 className="font-semibold mb-3" style={previewStyles.fieldLabel}>After teaching the unit</h4>
                    <div className="text-text-secondary">
                ...
                <div className="p-4 rounded-lg border-l-4" style={previewStyles.secondaryBlock}>
                    <h4 className="font-semibold mb-3" style={previewStyles.fieldLabel}>Future planning</h4>
                    <div className="text-text-secondary">

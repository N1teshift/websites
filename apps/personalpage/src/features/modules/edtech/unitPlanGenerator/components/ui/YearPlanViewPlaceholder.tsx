    ...
    <div className="flex items-center justify-center min-h-[60vh] p-6">
      <div className="max-w-2xl w-full">
        <div className="bg-surface-card rounded-lg border-2 border-border-default p-8 text-center">
          ...
          <p className="text-lg text-brand font-medium mb-4">Coming Soon</p>

          <div className="bg-surface-button rounded-lg p-6 mb-6 text-left border border-border-default">
            <p className="text-text-primary mb-4">
              This section is not yet available in Year Plan View mode. Year Plan View allows you to
              see and edit the same fields across all your unit plans simultaneously.
            </p>
            <p className="text-text-secondary text-sm">
              To access this section now, please use the <strong>view mode toggle</strong> in the
              navigation tabs to switch back to <strong>Individual Plan</strong> mode.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <div className="text-sm text-text-muted flex items-center justify-center">
              <span>
                Switch to Individual Plan mode using the toggle in the tabs above, or continue
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-text-muted">
            💡 <strong>Tip:</strong> Year Plan View will be implemented section by section. Check

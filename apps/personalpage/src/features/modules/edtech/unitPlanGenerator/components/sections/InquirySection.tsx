...
const InquirySection: React.FC<InquirySectionProps> = ({
  ...
  return (
    <div className="space-y-8 animate-fade-in">
          ...
          <div className="mt-2">
            <Dropdown
              ...
              options={[
                ...
                {
                  label: "personal_and_cultural_expression",
                  value: "Personal and Cultural Expression",
                },
                {
                  label: "scientific_and_technical_innovation",
                  value: "Scientific and Technical Innovation",
                },
                {
                  label: "globalization_and_sustainability",
                  value: "Globalization and Sustainability",
                },
      ...
      <FormField
        label={
          unitPlan.outputMapping === "current" ? "Statement of inquiry" : t("inquiry_statement")
        }

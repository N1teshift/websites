        ...
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2">
              <div
                className={`w-3 h-3 rounded-full ${getProgressColor(overallProgress)} shadow-soft animate-pulse`}
              ></div>
            ...
            {showPercentage && (
              <div
                className={`px-3 py-1 rounded-full text-sm font-bold ${getTextColor(overallProgress)} bg-opacity-10`}
                style={{
                  backgroundColor: getProgressColor(overallProgress).includes("green")
                    ? "#22c55e20"
                    : getProgressColor(overallProgress).includes("blue")
                      ? "#3b82f620"
                      : getProgressColor(overallProgress).includes("yellow")
                        ? "#f59e0b20"
                        : getProgressColor(overallProgress).includes("orange")
                          ? "#f9731620"
                          : "#ef444420",
                }}
              >

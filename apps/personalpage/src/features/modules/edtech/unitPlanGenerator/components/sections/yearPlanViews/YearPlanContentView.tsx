...
const YearPlanContentView: React.FC<YearPlanContentViewProps> = ({
  ...
  const [editingCell, setEditingCell] = useState<{
    planId: string;
    subunitIndex: number;
    field: "subunitName" | "lessonsPerSubunit";
  } | null>(null);
    ...
    <div className="space-y-6 p-6">
      <div>
        ...
        <p className="text-text-secondary mb-6">
          View and edit all unit sections and lesson counts across your entire year plan. Click on
          any section name or lesson count to edit it inline.
        </p>
      </div>
              ...
              <div className="bg-surface-button px-6 py-4 border-b-2 border-border-default">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <div className="text-2xl font-bold text-brand">{totalLessons}</div>
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <button
                            onClick={() => {
                              if (
                                confirm(
                                  `Remove section "${subunit.subunitName || `Section ${subunit.subunitNumber}`}"?`
                                )
                              ) {

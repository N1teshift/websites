        ...
        <div className="space-y-6 p-6">
            <div>
                ...
                <p className="text-text-secondary mb-6">
                    View and edit community engagement activities across all your unit plans. 
                    Click on any entry to edit it inline.
                </p>
            </div>
            ...
            <div className="space-y-4">
                {sortedUnitPlans.map((plan) => {
                    ...
                    const hasContent = plan.data.communityEngagement && plan.data.communityEngagement.trim().length > 0;
                                        ...
                                        {hasContent ? (
                                            ...
                                            <div className="flex items-center justify-center h-full text-text-muted italic">
                                                <div className="text-center">
                                                    ...
                                                    <p className="text-sm mt-1 opacity-0 group-hover:opacity-100 transition-opacity">Click to add</p>
                                                </div>
                                            </div>
                                        )}
                                    </div>
            ...
            <div className="bg-surface-card border-2 border-border-default rounded-lg p-6">
                <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                        <h4 className="text-sm font-semibold text-text-secondary uppercase tracking-wide">With Community Engagement</h4>
                        <p className="text-2xl font-bold text-brand mt-1">
                            {unitPlans.filter(plan => plan.data.communityEngagement && plan.data.communityEngagement.trim().length > 0).length}
                        </p>
                    </div>
                </div>
            </div>

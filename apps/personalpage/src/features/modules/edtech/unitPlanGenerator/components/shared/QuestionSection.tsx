...
const QuestionSection: React.FC<QuestionSectionProps> = ({
  ...
  return (
    <div>
      <h3 className="text-lg font-semibold text-text-primary mb-4">{t("inquiry_questions")}</h3>
      <p className="text-sm text-text-secondary mb-6">{t("inquiry_questions_description")}</p>

          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-text-secondary mb-4">
                Export a clean overview of your entire year plan showing all unit titles, order
                numbers, and lesson counts in a single summary page. Perfect for year planning and
      ...
      <div className="mt-6 p-6 bg-surface-card rounded-lg border-2 border-border-default">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-text-secondary mb-4">
              {t("export_combined_html_description") ||
                "Export all loaded unit plans as a single HTML document with all plans combined into one file for easy viewing and printing."}
            </p>
            <button
        ...
        <div className="mt-6 p-6 bg-surface-card rounded-lg border-2 border-border-default">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-text-secondary mb-4">
                Download a ZIP archive containing separate files for each unit plan. Each plan is
                exported as its own standalone file for individual distribution or archiving.
              </p>
              <div className="flex gap-3">
                {exportAllPlansAsZipHTML && (
                  <button

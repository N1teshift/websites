                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                        ...
                        <div className="space-y-1 text-sm text-gray-600">
                            <p><strong>Title:</strong> {formData.title || '(empty)'}</p>
                            <p><strong>Deadline:</strong> {formData.deadline || '(not set)'}</p>
                            <p><strong>Columns:</strong> {formData.assessmentColumns.filter(c => c.trim()).join(', ') || '(none)'}</p>
                        </div>
                    </div>

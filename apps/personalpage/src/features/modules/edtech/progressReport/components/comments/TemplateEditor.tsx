    ...
    return (
      <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
        <div className="flex justify-between items-center mb-3">
          <h3 className="text-sm font-semibold text-gray-700">Template: {activeTemplate.name}</h3>
          <button
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-300 p-6 space-y-6">
      <div className="flex justify-between items-center">
        <h3 className="text-lg font-semibold text-gray-900">Editing: {activeTemplate.name}</h3>
        <button

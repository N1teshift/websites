        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {students.length > 0 ? (
            students.map((student) => {
              ...
              return (
                <tr key={studentKey} className="group hover:bg-blue-50 transition-colors">
                  {visibleColumns.map((column) => {
                    if (column.id === "name") {
                      return (
                        <td
                    ...
                    const displayValue = inlineEditing.getCellValue(
                      student,
                      assessmentId,
                      scoreType
                    );
                    ...
                    return (
                      <AssessmentCell
                        ...
                        onEdit={(value) =>
                          inlineEditing.handleCellEdit(studentKey, assessmentId, scoreType, value)
                        }

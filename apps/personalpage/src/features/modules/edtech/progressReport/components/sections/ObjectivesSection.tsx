...
const ObjectivesSection: React.FC<ObjectivesSectionProps> = ({
  ...
  const findStudentsMissingAssessments = useCallback(
    (assessmentIds: string[]) => {
      ...
      students.forEach((student) => {
        ...
        assessmentIds.forEach((assessmentId) => {
          ...
          const isMissing =
            !assessment || assessment.score === "" || assessment.score === "n" || !assessment.score;
  ...
  const dynamicMissions = useMemo(() => {
    ...
    findStudentsMissingKD2,
    findStudentsMissingSDTests,
    findStudentsMissingSD456,
    findStudentsMissingSD789,
    findStudentsMissingKD3,
  ]);
  ...
  const handleCreateMission = useCallback(
    (formData: {
      ...
      const assessmentIds = formData.assessmentColumns.map((col) =>
      ...
      const newMission: Mission = {
        ...
        description:
          ...
          `Students must complete: ${formData.assessmentColumns.join(", ")}`,
  ...
  const getMissionProgress = (mission: Mission) => {
    ...
    const studentsWithDetails = activeStudents
      .map((studentProgress) => {
    ...
    const studentsByClass: StudentDetailsByClass =
      studentsWithDetails.reduce<StudentDetailsByClass>((acc, item) => {
  ...
  const handleGradeInput = useCallback(
    (studentId: string, assessmentType: "KD" | "SD1" | "SD2" | "SD3", value: string) => {
            ...
            return (
              <div
                ...
                className={`bg-white rounded-lg shadow-md border-2 overflow-hidden transition-all hover:shadow-lg ${
                  isPassed ? "border-red-300" : isUrgent ? "border-orange-300" : "border-blue-300"
                }`}
              >
                {/* Mission Header */}
                <div
                  className={`px-6 py-4 ${
                    isPassed ? "bg-red-50" : isUrgent ? "bg-orange-50" : "bg-blue-50"
                  }`}
                >
                    ...
                    <div>
                      ...
                      <p
                        className={`text-base font-semibold ${
                          isPassed ? "text-red-600" : isUrgent ? "text-orange-600" : "text-gray-900"
                        }`}
                      >
                        ...
                        {isPassed && <span className="ml-2 text-sm text-red-500">(Overdue)</span>}
                      </p>
                    </div>
                  </div>
                      ...
                      <div className="space-y-2 max-h-96 overflow-y-auto">
                        {Object.entries(progress.studentsByClass)
                          ...
                          .map(([className, classStudents]) => (
                            ...
                            >
                              <div className="flex items-center justify-between mb-2">
                                <h5 className="font-semibold text-gray-900 text-sm">{className}</h5>
                                  ...
                                  return (
                                    ...
                                    >
                                      ...
                                      <div className="flex items-center space-x-2 mt-2">
                                        {mission.check_type === "column" &&
                                          mission.assessment_column === "KD2" && (
                                            <div className="flex items-center space-x-2">
                                              ...
                                              <input
                                                ...
                                                placeholder="0-10"
                                                value={
                                                  gradeInputs.get(`${item.student.id}-KD`)?.value ||
                                                  ""
                                                }
                                                onChange={(e) =>
                                                  handleGradeInput(
                                        ...
                                        {mission.check_type === "assessment-ids" &&
                                          item.missingTests.map((testName) => (
                                            <div
                                              key={testName}
                                            ...
                                            >
                                              ...
                                              <input
                                                ...
                                                placeholder="0-10"
                                                value={
                                                  gradeInputs.get(`${item.student.id}-${testName}`)
                                                    ?.value || ""
                                                }
                                                onChange={(e) =>
                                                  handleGradeInput(

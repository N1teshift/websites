...
import { getStrandForObjective, getUnitsForObjective } from '@progressReport/student-data/config/cambridgeObjectiveMapping';
...
export const MissionDetails: React.FC<MissionDetailsProps> = ({
    ...
    const objectivesByStrand = Object.entries(mission.objectives).reduce((acc, [code, obj]) => {
                                                ...
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="text-xs text-gray-500">
                                                            Units: {Array.isArray(getUnitsForObjective(obj.code)) 

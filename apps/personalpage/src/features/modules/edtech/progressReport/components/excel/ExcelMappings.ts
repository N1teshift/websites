...
export const excelMappings: ExcelMapping[] = [
  ...
  {
    field: "conceptualUnderstandings",
    cell: "D15",
  ...
  {
    field: "globalContextExplanation",
    cell: "G15",
    label: "Global Context Explanation",
    type: "string",
  },
...
export const formatOptions: ExcelFormatOption[] = [
  {
    ...
    description:
      "Complete KMM MYP Unit Plan template with proper structure, headers, merged cells, exact column/row dimensions, and professional dark blue header styling",
  },
];

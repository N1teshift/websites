      ...
      <div className="flex items-start">
        ...
        <div className="ml-3 flex-1">
          <h3 className="text-sm font-medium text-yellow-800">
            Missing Assessment Data ({studentsWithMissingData.length} student
            {studentsWithMissingData.length !== 1 ? "s" : ""})
          </h3>
          <div className="mt-2 text-sm text-yellow-700">
            <p className="mb-2">
              The following students are missing required assessment data and won&apos;t have
              comments generated:
            </p>

            ...
            return (a: StudentData, b: StudentData) => {
                ...
                const getScore = (student: StudentData) => {
                    ...
                    if (scoreType && assessment.evaluation_details) {
                        if (scoreType === 'percentage') return assessment.evaluation_details.percentage_score || 0;
                        if (scoreType === 'myp') return assessment.evaluation_details.myp_score || 0;
                        if (scoreType === 'cambridge') return assessment.evaluation_details.cambridge_score || 0;
                    }
...
export type ScoreType = 'percentage' | 'myp' | 'cambridge' | 'cambridge_1' | 'cambridge_2' | 

...
export function generateMathComment(
  ...
  if (uniqueWeakSections.length > 0) {
    ...
    if (uniqueWeakSections.length === 1) {
      if (uniqueWeakSections[0] === "1.1")
        topicDescription = template.topicDescriptions.section_1_1;
      else if (uniqueWeakSections[0] === "1.2")
        topicDescription = template.topicDescriptions.section_1_2;
      else if (uniqueWeakSections[0] === "1.3")
        topicDescription = template.topicDescriptions.section_1_3;
    } else if (uniqueWeakSections.length === 2) {
      const topics = uniqueWeakSections.map((section) => {
        const desc =
          section === "1.1"
            ? template.topicDescriptions.section_1_1
            : section === "1.2"
              ? template.topicDescriptions.section_1_2

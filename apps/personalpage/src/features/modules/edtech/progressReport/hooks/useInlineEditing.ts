...
interface UseInlineEditingReturn {
    ...
    handleCellEdit: (studentKey: string, assessmentId: string, scoreType: ScoreType, newValue: string) => void;
...
export function useInlineEditing({ 
    ...
    const getCellValue = useCallback((
        ...
        if (scoreType) {
            ...
            if (scoreType === 'paper1' && assessment.paper1_score !== undefined && assessment.paper1_score !== null) {
                return String(assessment.paper1_score);
            } else if (scoreType === 'paper1_percent' && assessment.paper1_percent !== undefined && assessment.paper1_percent !== null) {
                return String(Math.round(assessment.paper1_percent * 10) / 10);
            } else if (scoreType === 'paper2' && assessment.paper2_score !== undefined && assessment.paper2_score !== null) {
                return String(assessment.paper2_score);
            } else if (scoreType === 'paper2_percent' && assessment.paper2_percent !== undefined && assessment.paper2_percent !== null) {
                return String(Math.round(assessment.paper2_percent * 10) / 10);
            } else if (scoreType === 'paper3' && assessment.paper3_score !== undefined && assessment.paper3_score !== null) {
                return String(assessment.paper3_score);
            } else if (scoreType === 'paper3_percent' && assessment.paper3_percent !== undefined && assessment.paper3_percent !== null) {
                return String(Math.round(assessment.paper3_percent * 10) / 10);
            } else if (scoreType === 'lis1' && assessment.lis1 !== undefined && assessment.lis1 !== null) {
                return String(assessment.lis1);
            } else if (scoreType === 'lis2' && assessment.lis2 !== undefined && assessment.lis2 !== null) {
                return String(assessment.lis2);
            } else if (scoreType === 'read' && assessment.read !== undefined && assessment.read !== null) {
                return String(assessment.read);
            } else if (scoreType === 'voc1' && assessment.voc1 !== undefined && assessment.voc1 !== null) {
                return String(assessment.voc1);
            } else if (scoreType === 'voc2' && assessment.voc2 !== undefined && assessment.voc2 !== null) {
            ...
            } else if (scoreType === 'total' && assessment.total_score !== undefined && assessment.total_score !== null) {
                return String(assessment.total_score);
            } else if (scoreType === 'percent' && assessment.total_percent !== undefined && assessment.total_percent !== null) {
                return String(Math.round(assessment.total_percent * 10) / 10); // Round to 1 decimal
            } else if (assessment.evaluation_details) {
                const scoreValue =
                    scoreType === 'percentage' ? assessment.evaluation_details.percentage_score :
                ...
                if (scoreValue === null || scoreValue === undefined) {
                    if (scoreType === 'percentage') {
                        if (assessment.score === '' || assessment.score === null || assessment.score === undefined) {
                            return '';
                        }

...
import { CommentTemplate, DEFAULT_TEMPLATE, ENGLISH_DIAGNOSTIC_1_TEMPLATE, ENGLISH_UNIT_1_TEMPLATE } from '../types/CommentTemplateTypes';
...
const DEFAULT_TEMPLATES = [DEFAULT_TEMPLATE, ENGLISH_DIAGNOSTIC_1_TEMPLATE, ENGLISH_UNIT_1_TEMPLATE];

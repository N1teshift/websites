...
export class StudentDataManager {
    ...
    constructor(dataDirectory?: string) {
        ...
        this.dataDirectory = dataDirectory || path.join(process.cwd(), 'src', 'features', 'student-data', 'data');
    ...
    private async processSheet(
        ...
        for (const row of sheetData.students) {
            ...
            let student = this.dataProcessor.findStudent(studentData, firstName, lastName, sheetData.className);

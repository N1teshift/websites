...
export class DataProcessorV3 {
        ...
        for (const [columnName, value] of Object.entries(row)) {
            ...
            if (value !== null && value !== undefined && value !== '' && value !== 'n') {
                ...
                const assessment: AssessmentV3 = {
                    date: assessmentDate,
                    column: columnName,
                    type: mapping.type as 'homework' | 'classwork' | 'summative' | 'diagnostic' | 'participation' | 'consultation',
     ...
     */
    findStudent(students: StudentDataV3[], firstName: string, lastName: string, className: string): StudentDataV3 | null {
        // Resolve name alias
     ...
     */
    createNewStudent(firstName: string, lastName: string, className: string, id: string): StudentDataV3 {

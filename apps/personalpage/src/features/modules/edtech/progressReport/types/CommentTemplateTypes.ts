...
export const DEFAULT_TEMPLATE: CommentTemplate = {
    ...
    sections: {
        ...
        context: '{Name} šiuose darbuose turėjo galimybę pademonstruoti ką mokėsi rugsėjo pirmosiomis savaitėmis temoje "Skaičiai ir skaičiavimai".',
        assessment: 'Savarankiškuose darbuose buvo tikrinamos MYP A kriterijaus "žinios ir supratimas" kompetencijos.',
        achievement: '{Name} pasiekė {MYP_Level} lygį.',
        weakIntro: '{Name} turi pasimokyti',
        weakEnding: 'nes {Subtopic_Word} žinias ir supratimą {Name_Kam} pademonstruoti sekėsi prasčiausiai.'
    },
    topicDescriptions: {
...
export const ENGLISH_DIAGNOSTIC_1_TEMPLATE: CommentTemplate = {
    ...
    sections: {
        ...
        context: '{Name} demonstrated reading and use of English skills ({Paper1_Percent}%), listening skills ({Paper2_Percent}%), and writing skills ({Paper3_Percent}%).',
        assessment: 'The diagnostic test assessed overall English language proficiency across multiple skills.',
...
export const ENGLISH_UNIT_1_TEMPLATE: CommentTemplate = {
    ...
    sections: {
        ...
        context: '{Name} was assessed on listening ({Listening_Score}/{Listening_Max}), reading ({Reading_Score}/{Reading_Max}), vocabulary ({Vocabulary_Score}/{Vocabulary_Max}), and grammar ({Grammar_Score}/{Grammar_Max}).',

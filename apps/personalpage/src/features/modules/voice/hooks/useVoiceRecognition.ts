...
export function useVoiceRecognition(onResult: (transcript: string) => void) {
        ...
        if (typeof window !== "undefined") {
            ...
            if (SpeechRecognitionConstructor) {
                ...
                recog.onerror = (event: Event) => {
                    ...
                    logger.error('Speech recognition error', new Error(`Speech recognition failed: ${errorCode}`), {
    ...
    const startListening = useCallback(() => {
        ...
        try {
            ...
            logger.error('Error starting speech recognition', error instanceof Error ? error : new Error(String(error)), {

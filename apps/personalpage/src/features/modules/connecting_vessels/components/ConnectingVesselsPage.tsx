...
export default function ConnectingVesselsPage() {
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8">
            ...
            <Card className="p-6">
                <h2 className="text-2xl font-bold text-text-primary mb-6 border-b-2 border-border-default pb-2">{t('project_overview')}</h2>
            ...
            {/* Technical Details */}
            <Card className="p-6">
                <h2 className="text-2xl font-bold text-text-primary mb-6 border-b-2 border-border-default pb-2">{t('technical_details')}</h2>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <h3 className="text-lg font-semibold text-text-primary mb-3">{t('technologies_used')}</h3>
                    ...
                    <div>
                        <h3 className="text-lg font-semibold text-text-primary mb-3">{t('technical_implementation')}</h3>
                        <p className="text-text-secondary leading-relaxed mb-4">{t('technical_details_text')}</p>
            ...
            {/* Open Source */}
            <Card className="p-6">
                <h2 className="text-2xl font-bold text-text-primary mb-6 border-b-2 border-border-default pb-2">{t('open_source')}</h2>

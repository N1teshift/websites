...
describe("ConnectingVesselsPage", () => {
  const mockUseFallbackTranslation = useFallbackTranslation as jest.MockedFunction<
    typeof useFallbackTranslation
  >;
  let mockT: jest.Mock;
  ...
  it("requests translations from the expected namespaces", () => {
    ...
    expect(mockUseFallbackTranslation).toHaveBeenCalledWith([
      "connecting_vessels",
      "links",
      "common",
    ]);

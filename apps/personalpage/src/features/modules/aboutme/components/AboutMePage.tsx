        ...
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            ...
            <header className="mb-8 text-center md:text-left">
                ...
                <div className="flex flex-wrap justify-center md:justify-start gap-x-6 gap-y-2 text-text-secondary">
                    <a href={`mailto:${t('email')}`} className="hover:text-brand-primary transition-colors flex items-center gap-2">
                        <FaEnvelope /> {t('email')}
                    </a>
                    <a href={`https://${t('linkedin')}`} target="_blank" rel="noopener noreferrer" className="hover:text-brand-primary transition-colors flex items-center gap-2" aria-label={t('linkedinAria')}>
            ...
            <section className="mb-8">
                <h2 className="text-2xl font-semibold pb-2 mb-4 text-text-primary border-b-2 border-border-default">{t('summaryTitle')}</h2>
                <p className="leading-relaxed text-text-secondary">{t('summaryContent')}</p>
            </section>

            {/* Technical Skills Section */}
            <section className="mb-8">
                <h2 className="text-2xl font-semibold pb-2 mb-4 text-text-primary border-b-2 border-border-default">{t('techSkillsTitle')}</h2>
            ...
            {/* Soft Skills Section */}
            <section className="mb-8">
                <h2 className="text-2xl font-semibold pb-2 mb-4 text-text-primary border-b-2 border-border-default">{t('softSkillsTitle')}</h2>
                <ul className="list-disc list-inside text-text-secondary space-y-1">
            ...
            <section className="mb-8">
                <h2 className="text-2xl font-semibold pb-2 mb-4 text-text-primary border-b-2 border-border-default">{t('experienceTitle')}</h2>
                <div className="space-y-6">
                    ...
                    {experience.map((exp, index) => (
                        <div key={index} className="border-l-4 border-brand-primary pl-4">
                            ...
                            {exp.company && <p className="text-md font-semibold text-text-secondary">{exp.company}</p>}
                            <p className="text-sm text-text-muted mb-1">{exp.location} · {exp.dates}</p>
            ...
            {/* Projects Section */}
            <section className="mb-8">
                <h2 className="text-2xl font-semibold pb-2 mb-4 text-text-primary border-b-2 border-border-default">{t('projectsTitle')}</h2>
            ...
            {/* Education Section */}
            <section className="mb-8">
                <h2 className="text-2xl font-semibold pb-2 mb-4 text-text-primary border-b-2 border-border-default">{t('educationTitle')}</h2>
            ...
            {/* Languages Section */}
            <section className="mb-8">
                <h2 className="text-2xl font-semibold pb-2 mb-4 text-text-primary border-b-2 border-border-default">{t('languagesTitle')}</h2>
            ...
            {/* Interests Section */}
            <section className="mb-8">
                <h2 className="text-2xl font-semibold pb-2 mb-4 text-text-primary border-b-2 border-border-default">{t('interestsTitle')}</h2>
                <ul className="list-disc list-inside text-text-secondary space-y-1">

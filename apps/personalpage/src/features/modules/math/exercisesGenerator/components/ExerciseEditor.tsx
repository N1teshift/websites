...
interface ExerciseEditorProps {
  ...
  handleFieldChange: <K extends keyof ExerciseDocumentData>(
    field: K,
 ...
 */
const ExerciseEditor: React.FC<ExerciseEditorProps> = ({ selectedExercise, handleFieldChange }) => {
  ...
  return (
    <div className="flex flex-col text-black gap-2">
      <ExerciseDetails selectedExercise={selectedExercise} handleFieldChange={handleFieldChange} />
      <RenderQuestion
      ...
      {selectedExercise.exerciseType === "test" ? (
        <RenderOptions
          ...
          onOptionsChange={(updatedOptions) => handleFieldChange("options", updatedOptions)}

import {
    PointSettings, CoefficientsSettings, CapitalLetters, capitalLettersOptions
...
export class PointTestGenerator extends TestGenerator<PointTestCase, PointSettings> {
     ...
     * @protected
     */
    protected createTestCase(settings: Partial<PointSettings> = {}, category?: string): PointTestCase | null {

import {
    IntervalSettings, CoefficientsSettings, CapitalLetters, capitalLettersOptions, IntervalType, intervalTypeOptions
...
export class IntervalTestGenerator extends TestGenerator<IntervalTestCase, IntervalSettings> {
     ...
     * @protected
     */
    protected createTestCase(settings: Partial<IntervalSettings> = {}, category?: string): IntervalTestCase | null {

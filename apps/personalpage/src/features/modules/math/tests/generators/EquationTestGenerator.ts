import { EquationSettings, ExpressionSettings } from '../../../math/types/mathObjectSettingsInterfaces';
...
export class EquationTestGenerator extends TestGenerator<EquationTestCase, EquationSettings> {
     ...
     * @protected
     */
    protected createTestCase(settings: Partial<EquationSettings> = {}, category?: string): EquationTestCase | null {
    ...
    public generateTermStructureTests(): EquationTestCase[] {
        return this.termOptions.map(terms => {
            const settings: Partial<EquationSettings> = { terms: terms as [ExpressionSettings] | [ExpressionSettings, ExpressionSettings] };
    ...
    public generateAllTests(): EquationTestCase[] {
        ...
        const allTests = [
            ...this.generateTermStructureTests()
        ];

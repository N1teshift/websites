import { InequalitySettings, ExpressionSettings, InequalityType, inequalityTypeOptions } from '@math/types/index';
...
export class InequalityTestGenerator extends TestGenerator<InequalityTestCase, InequalitySettings> {
     ...
     * @protected
     */
    protected createTestCase(settings: Partial<InequalitySettings> = {}, category?: string): InequalityTestCase | null {
    ...
    public generateInequalityTypeTests(): InequalityTestCase[] {
        return this.generateSinglePropertyTests(this.inequalityTypes, 'inequalityType', 'inequalityType');
    }
    ...
    public generateAllTests(): InequalityTestCase[] {
        ...
        const allTests = [
            ...this.generateInequalityTypeTests(),

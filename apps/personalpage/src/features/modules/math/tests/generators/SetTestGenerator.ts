import { SetSettings, CoefficientsSettings, CapitalLetters, capitalLettersOptions } from '@math/types/index';
...
export class SetTestGenerator extends TestGenerator<SetTestCase, SetSettings> {
     ...
     * @protected
     */
    protected createTestCase(settings: Partial<SetSettings> = {}, category?: string): SetTestCase | null {
    ...
    public generateCollectionCountTests(): SetTestCase[] {
        return this.collectionCounts.map(collectionCount => {

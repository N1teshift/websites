import {
    NumberSet, CoefficientRule, RepresentationType,
    numberSetOptions, representationTypeOptions, coeficientRuleOptions, CoefficientSettings,
    RANGE_TYPES
 ...
 */
export class CoefficientTestGenerator extends TestGenerator<CoefficientTestCase, CoefficientSettings> {
    //**** Class Properties ****//
     ...
     * @protected
     */
    protected createTestCase(settings: Partial<CoefficientSettings> = {}, category?: string): CoefficientTestCase | null {
    ...
    public generateRuleTests(): CoefficientTestCase[] {
        return this.rules.map(rule => 
            this.generateTestCase({ rules: [rule] }, 'single rule')
    ...
    public generateRepresentationTests(): CoefficientTestCase[] {
        return this.generateSinglePropertyTests(this.representationTypes, 'representationType', 'representation type');
    }

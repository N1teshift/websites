...
export abstract class ComplexityBuilder<T> {
     ...
     * @protected
     */
    protected addComplexityIf(condition: boolean, complexityValue: number, baseScore: number = 0): number {
     ...
     * @protected
     */
    protected multiplyComplexityIf(condition: boolean, multiplier: number, baseScore: number = 1): number {

...
import { MathObjectSettings, MathObjectSettingsType } from "../../types/mathObjectSettingsInterfaces";
import {
    CoefficientRenderer, CoefficientsRenderer, TermRenderer, TermsRenderer, FunctionRenderer,
    EquationRenderer, InequalityRenderer, SetRenderer, PointRenderer, IntervalRenderer, ExpressionRenderer
} from "../renderers"
...
const rendererMap: Record<string, RendererMapping> = {
    coefficient: { Component: CoefficientRenderer as React.ComponentType<RendererProps>, settingsKey: "coefficientSettings" },
    coefficients: { Component: CoefficientsRenderer as React.ComponentType<RendererProps>, settingsKey: "coefficientsSettings" },
    term: { Component: TermRenderer as React.ComponentType<RendererProps>, settingsKey: "termSettings" },
    terms: { Component: TermsRenderer as React.ComponentType<RendererProps>, settingsKey: "termsSettings" },
    expression: { Component: ExpressionRenderer as React.ComponentType<RendererProps>, settingsKey: "expressionSettings" },
    equation: { Component: EquationRenderer as React.ComponentType<RendererProps>, settingsKey: "equationSettings" },
    inequality: { Component: InequalityRenderer as React.ComponentType<RendererProps>, settingsKey: "inequalitySettings" },
    function: { Component: FunctionRenderer as React.ComponentType<RendererProps>, settingsKey: "functionSettings" },
    point: { Component: PointRenderer as React.ComponentType<RendererProps>, settingsKey: "pointSettings" },
    set: { Component: SetRenderer as React.ComponentType<RendererProps>, settingsKey: "setSettings" },
    interval: { Component: IntervalRenderer as React.ComponentType<RendererProps>, settingsKey: "intervalSettings" },
};

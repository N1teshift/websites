 ...
 */
export interface BaseMathObjectRendererProps<T extends MathObjectSettingsType>
    ...
    onInterfaceChange?: (newInterface: InterfaceType, updateSettings: (newSettings: T) => void) => void;
}

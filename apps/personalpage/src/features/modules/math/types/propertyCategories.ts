 ...
 */
export type CoefficientsProperty = "collectionCount" | "coefficientsRule"; // Refer to a rule from CoefficientsSettings.rules
 ...
 */
export type PropertyCategory = BaseProperty | CoefficientProperty | CoefficientsProperty;

import {
    CapitalLetters, CombinationType, CoefficientRule, CoefficientsRule, FunctionName, InequalityType,
    IntervalType, NumberSet, ObjectType, RepresentationType, VariableName
} from "./mathTypes";
...
export type MathInput =
    | { objectType: "coefficient"; coefficientSettings: CoefficientSettings; priority?: number; dependency?: string; example?: string; }
    | { objectType: "coefficients"; coefficientsSettings: CoefficientsSettings; priority?: number; dependency?: string; example?: string; }
    | { objectType: "term"; termSettings: TermSettings; priority?: number; dependency?: string; example?: string; }
    | { objectType: "terms"; termsSettings: TermsSettings; priority?: number; dependency?: string; example?: string; }
    | { objectType: "expression"; expressionSettings: ExpressionSettings; priority?: number; dependency?: string; example?: string; }
    | { objectType: "equation"; equationSettings: EquationSettings; priority?: number; dependency?: string; example?: string; }
    | { objectType: "function"; functionSettings: FunctionSettings; priority?: number; dependency?: string; example?: string; }
    | { objectType: "point"; pointSettings: PointSettings; priority?: number; dependency?: string; example?: string; }
    | { objectType: "interval"; intervalSettings: IntervalSettings; priority?: number; dependency?: string; example?: string; }
    | { objectType: "set"; setSettings: SetSettings; priority?: number; dependency?: string; example?: string; }
    | { objectType: "inequality"; inequalitySettings: InequalitySettings; priority?: number; dependency?: string; example?: string; };

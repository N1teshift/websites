...
function getAssessmentTemplate(assessment: Assessment): { id: string; title: string } {
    ...
    if (type === 'classwork') {
        ...
        if ((column === 'EXT1' || column === 'EXT2' || column === 'EXT3') && 
            date >= '2025-09-12' && date <= '2025-09-25') {
        ...
        if (column === 'EXT1' && date === '2025-10-06') {
            return { id: 'classwork-notes-check-oct6', title: 'Board Notes Check - Monomials & Polynomials' };
        }
        // Exercise progress tracking
        if ((column === 'EXT1' || column === 'EXT2' || column === 'EXT3' || 
             column === 'EXT4' || column === 'EXT5') && 
...
function migrateAssessment(assessment: Assessment): Assessment {
    ...
    if (migrated.column === 'ND1' && migrated.date === '2025-10-10' && migrated.type === 'weekly_assessment') {
        migrated.column = 'ND5';
...
async function migrate() {
    ...
    try {
        ...
        console.log(`   Total assessments: ${v4_1Students.reduce((sum, s) => sum + s.assessments.length, 0)}`);
        console.log(`\n📝 Changes made:`);

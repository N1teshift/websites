...
const rules: StandardizationRule[] = [
  // Diagnostics: Diag1 → D1, Diag2 → D2
  {
    ...
    newColumn: "D1",
    newAssessmentId: "d1",
    newAssessmentTitle: "D1",
    newTaskName: "D1: Diagnostic",
  },
  {
    oldColumn: "Diag2",
    newColumn: "D2",
    newAssessmentId: "d2",
    newAssessmentTitle: "D2",
    newTaskName: "D2: Diagnostic",
  },
  ...
  // KD: Unit 2 → KD2
  {
    ...
    newColumn: "KD2",
    newAssessmentId: "kd2",
    newAssessmentTitle: "KD2",
    newTaskName: "KD2: Cambridge Unit 2",
  },
  ...
  // KD1 stays KD1 but standardize
  {
    ...
    newColumn: "KD1",
    newAssessmentId: "kd1",
    newAssessmentTitle: "KD1",
    newTaskName: "KD1: Cambridge Unit 1",
  },
  ...
  // Generated grade: PG → P1
  {
    ...
    newColumn: "P1",
    newAssessmentId: "p1",
    newAssessmentTitle: "P1",
    newTaskName: "P1: Generated Grade",
  },
  ...
  // Tests: Standardize IDs and titles
  {
    ...
    newColumn: "SD1",
    newAssessmentId: "sd1",
    newAssessmentTitle: "SD1",
    newTaskName: "SD1: Irrational Numbers",
  },
  {
    oldColumn: "SD2",
    newColumn: "SD2",
    newAssessmentId: "sd2",
    newAssessmentTitle: "SD2",
    newTaskName: "SD2: Standard Form",
  },
  {
    oldColumn: "SD3",
    newColumn: "SD3",
    newAssessmentId: "sd3",
    newAssessmentTitle: "SD3",
    newTaskName: "SD3: Indices",
  },
  {
    oldColumn: "SD4",
    newColumn: "SD4",
    newAssessmentId: "sd4",
    newAssessmentTitle: "SD4",
    newTaskName: "SD4: Summative",
  },
  {
    oldColumn: "SD5",
    newColumn: "SD5",
    newAssessmentId: "sd5",
    newAssessmentTitle: "SD5",
    newTaskName: "SD5: Summative",
  },
  ...
  // Homework: Standardize and renumber (remove gap)
  {
    ...
    newColumn: "ND1",
    newAssessmentId: "nd1",
    newAssessmentTitle: "ND1",
    newTaskName: "ND1: Homework",
  },
  {
    oldColumn: "ND2",
    newColumn: "ND2",
    newAssessmentId: "nd2",
    newAssessmentTitle: "ND2",
    newTaskName: "ND2: Homework",
  },
  {
    oldColumn: "ND3",
    newColumn: "ND3",
    newAssessmentId: "nd3",
    newAssessmentTitle: "ND3",
    newTaskName: "ND3: Graded Homework",
  },
  {
    oldColumn: "ND5",
    newColumn: "ND4",
    newAssessmentId: "nd4",
    newAssessmentTitle: "ND4",
    newTaskName: "ND4: Reflection",
  },
  {
    oldColumn: "ND6",
    newColumn: "ND5",
    newAssessmentId: "nd5",
    newAssessmentTitle: "ND5",
    newTaskName: "ND5: Homework",
  },
  ...
  // Classwork: Standardize
  {
    oldColumn: "EXT1",
    newColumn: "EXT1",
    newAssessmentId: "ext1",
    newAssessmentTitle: "EXT1",
    newTaskName: "EXT1: Exercise Progress",
  },
  {
    oldColumn: "EXT2",
    newColumn: "EXT2",
    newAssessmentId: "ext2",
    newAssessmentTitle: "EXT2",
    newTaskName: "EXT2: Exercise Progress",
  },
  {
    oldColumn: "EXT3",
    newColumn: "EXT3",
    newAssessmentId: "ext3",
    newAssessmentTitle: "EXT3",
    newTaskName: "EXT3: Exercise Progress",
  },
  {
    oldColumn: "EXT4",
    newColumn: "EXT4",
    newAssessmentId: "ext4",
    newAssessmentTitle: "EXT4",
    newTaskName: "EXT4: Exercise Progress",
  },
  {
    oldColumn: "EXT5",
    newColumn: "EXT5",
    newAssessmentId: "ext5",
    newAssessmentTitle: "EXT5",
    newTaskName: "EXT5: Exercise Progress",
  },
  {
    oldColumn: "EXT6",
    newColumn: "EXT6",
    newAssessmentId: "ext6",
    newAssessmentTitle: "EXT6",
    newTaskName: "EXT6: Exercise Progress",
  },
  {
    oldColumn: "EXT7",
    newColumn: "EXT7",
    newAssessmentId: "ext7",
    newAssessmentTitle: "EXT7",
    newTaskName: "EXT7: Exercise Progress",
  },
  {
    oldColumn: "EXT8",
    newColumn: "EXT8",
    newAssessmentId: "ext8",
    newAssessmentTitle: "EXT8",
    newTaskName: "EXT8: Exercise Progress",
  },
  ...
  // Board solving: Standardize
  {
    oldColumn: "LNT1",
    newColumn: "LNT1",
    newAssessmentId: "lnt1",
    newAssessmentTitle: "LNT1",
    newTaskName: "LNT1: Board Participation",
  },
  {
    oldColumn: "LNT6",
    newColumn: "LNT6",
    newAssessmentId: "lnt6",
    newAssessmentTitle: "LNT6",
    newTaskName: "LNT6: Board Participation",
  },
  {
    oldColumn: "LNT7",
    newColumn: "LNT7",
    newAssessmentId: "lnt7",
    newAssessmentTitle: "LNT7",
    newTaskName: "LNT7: Board Participation",
  },
  {
    oldColumn: "LNT8",
    newColumn: "LNT8",
    newAssessmentId: "lnt8",
    newAssessmentTitle: "LNT8",
    newTaskName: "LNT8: Board Participation",
  },
  ...
  // Social hours: Standardize
  {
    ...
    newColumn: "SOC",
    newAssessmentId: "soc",
    newAssessmentTitle: "SOC",
    newTaskName: "SOC: Social Hours",
  },
];

...
function generateMissions(data: ProgressReportData): Mission[] {
    ...
    const missions: Mission[] = [
        ...
        },
        {
            ...
            assessment_ids: ['test-u1s1-irrational-numbers', 'test-u1s2-standard-form', 'test-u1s3-indices'],
...
function main() {
    ...
    if (args.length < 1) {
        ...
        console.error('Example: npx ts-node scripts/generateMissions.ts master_student_data_v4_45.json master_student_data_v4_46.json');
        process.exit(1);
    }

...
function extractTranslationKeys() {
  ...
  console.log(`✅ Scanned ${processedFiles}/${totalFiles} files, found ${keys.size} unique translation keys\n`);
...
function getLocaleKeys() {
  ...
  console.log(`✅ Processed ${processedLocaleFiles}/${totalLocaleFiles} locale files, found ${keys.size} total keys\n`);
  return Array.from(keys);
}
...
function generateCoverageReport() {
  ...
  console.log(`   • Coverage: ${((codeKeys.length - missing.length) / codeKeys.length * 100).toFixed(1)}%`);

...
function extractTranslationKeys() {
  ...
  console.log(
    `✅ Scanned ${sourceFiles.length} files (${filesWithKeys} with keys), found ${keys.size} unique translation keys\n`
  );
...
export { MockI18n, checkMissingTranslations, checkUnusedTranslations, generateReport };

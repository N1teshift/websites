...
describe("Screen Reader Compatibility", () => {
  ...
  describe("Basic screen reader support", () => {
    ...
    it("should provide text content for screen readers", () => {
      // Arrange
      const TestComponent = () => <button>Submit Form</button>;
  ...
  describe("ARIA labels for screen readers", () => {
    it("should use aria-label for screen reader text", () => {
      // Arrange
      const TestComponent = () => <button aria-label="Close dialog">×</button>;
    ...
    it("should combine aria-label and text content appropriately", () => {
      // Arrange
      const TestComponent = () => <button aria-label="Delete item">Remove</button>;
  ...
  describe("Image accessibility", () => {
    it("should provide alt text for images", () => {
      // Arrange
      const TestComponent = () => <img src="/test.jpg" alt="Descriptive alt text" />;
    ...
    it("should mark decorative images appropriately", () => {
      // Arrange
      const TestComponent = () => <img src="/decoration.jpg" alt="" role="presentation" />;

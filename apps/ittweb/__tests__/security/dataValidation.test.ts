import {
  ...
  uploadImage,
  extractYouTubeId,
} from "@/features/modules/community/archives/services/archiveService";
...
describe("Security: Data Validation", () => {
  ...
  describe("Input Sanitization", () => {
    ...
    it("should sanitize HTML entities", () => {
      const htmlEntities = ["&lt;script&gt;", "&amp;lt;script&amp;gt;", "&#60;script&#62;"];
  ...
  describe("File Upload Validation", () => {
    ...
    it("should reject files with wrong MIME types", async () => {
      const wrongMimeFile = createMockFile(
        "malicious.exe",
        1 * 1024 * 1024,
        "application/x-msdownload"
      );
    ...
    it("should handle malicious file names", () => {
      const maliciousNames = ["../../../etc/passwd", "file.php", "file.exe", "file<script>.jpg"];

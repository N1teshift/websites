...
describe("createApiHandler", () => {
  ...
  it("validates request body with custom validator", async () => {
    ...
    await handler(
      { method: "POST", url: "/test", body: { bad: true }, query: {} } as NextApiRequest,
      res
    );
  ...
  describe("Authentication", () => {
    ...
    it("allows unauthenticated requests when requireAuth is false", async () => {
      ...
      await handler(
        { method: "GET", url: "/public", body: null, query: {} } as NextApiRequest,
        res
      );
  ...
  it("handles POST requests correctly", async () => {
    ...
    await handler(
      { method: "POST", url: "/test", body: { data: "test" }, query: {} } as NextApiRequest,
      res
    );
  ...
  it("accepts multiple allowed methods", async () => {
    ...
    await handler(
      { method: "DELETE", url: "/test", body: null, query: {} } as NextApiRequest,
      res3
    );
  ...
  it("handles method case variations", async () => {
    ...
    await handler(
      { method: "get" as any, url: "/test", body: null, query: {} } as NextApiRequest,
      res
    );
  ...
  it("handles oversized payloads gracefully", async () => {
    ...
    await handler(
      { method: "POST", url: "/large", body: largeBody, query: {} } as NextApiRequest,
      res
    );
  ...
  describe("Cache Control", () => {
    it("sets cache headers for GET requests with cacheControl options", async () => {
      ...
      await handler(
        { method: "GET", url: "/cached", body: null, query: {} } as NextApiRequest,
        res
      );
    ...
    it("sets private cache headers when private option is true", async () => {
      ...
      await handler(
        { method: "GET", url: "/private", body: null, query: {} } as NextApiRequest,
        res
      );
    ...
    it("disables caching when cacheControl is false", async () => {
      ...
      await handler(
        { method: "GET", url: "/nocache", body: null, query: {} } as NextApiRequest,
        res
      );
  ...
  describe("Additional HTTP Methods", () => {
    it("handles PUT requests", async () => {
      ...
      await handler(
        { method: "PUT", url: "/test", body: { id: "1" }, query: {} } as NextApiRequest,
        res
      );
    ...
    it("handles PATCH requests", async () => {
      ...
      await handler(
        { method: "PATCH", url: "/test", body: { field: "value" }, query: {} } as NextApiRequest,
        res
      );

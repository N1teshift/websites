...
- **[Documentation Lifecycle](./documentation-lifecycle.md)** - Documentation lifecycle management

## 🎯 Purpose

This section contains:

- Reference guides that apply to multiple contexts
- Standards and conventions
- Best practices that may be relevant in production
- Documentation about documentation itself

Consider keeping this section even after going to production, as it contains generally useful reference materials.

      ...
      <ErrorBoundary>
        <>
          ...
          <div className="min-h-[calc(100vh-8rem)]">
            <PageHero title="Edit Post" description="Update an existing post" />
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
              <div className="rounded-xl border border-red-500/30 bg-red-900/20 p-6 backdrop-blur">
                <p className="text-red-200">You do not have permission to edit this post.</p>
              </div>
            </div>
          </div>
        </>
          ...
          <div className="min-h-[calc(100vh-8rem)]">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
              <div className="rounded-xl border border-amber-500/30 bg-black/30 p-6 backdrop-blur">
                <p className="text-gray-200">Post not found.</p>
              </div>
            </div>
          </div>
        </>

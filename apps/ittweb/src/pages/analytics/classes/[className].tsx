    ...
    <ErrorBoundary>
      <div className="min-h-[calc(100vh-8rem)]">
        ...
        <div className="container mx-auto px-4 py-8 space-y-6">
          ...
          <Link
            href="/analytics/classes"
            className="text-amber-400 hover:text-amber-300 inline-block"
          >
            ← Back to Class Statistics
          </Link>
          ...
          {classWinRate && (
            <ClassWinRateChart data={[classWinRate]} title={`${displayName} Win Rate`} />
          )}
                ...
                <table className="w-full" role="table" aria-label="Top players for this class">
                  <thead>
                    <tr className="border-b border-amber-500/20">
                      <th scope="col" className="text-left py-2 px-4 text-amber-400">
                        Rank
                      </th>
                      <th scope="col" className="text-left py-2 px-4 text-amber-400">
                        Player
                      </th>
                      <th scope="col" className="text-right py-2 px-4 text-amber-400">
                        Record
                      </th>
                      <th scope="col" className="text-right py-2 px-4 text-amber-400">
                        Win Rate
          ...
          <Card variant="medieval" className="p-4">
            <p className="text-sm text-gray-400">
              <strong className="text-amber-400">Note:</strong> Game history and trends over time
              features are planned for future implementation.
            </p>
          </Card>
        </div>
      </div>

...
const { getWinRateData } = jest.requireMock(
...
describe("GET /api/analytics/win-rate", () => {
  ...
  it("should filter by player name", async () => {
    ...
    // Assert
    expect(getWinRateData).toHaveBeenCalledWith("TestPlayer", undefined, undefined, undefined);
  });
  ...
  it("should filter by category", async () => {
    ...
    // Assert
    expect(getWinRateData).toHaveBeenCalledWith(undefined, "category1", undefined, undefined);
  });
  ...
  it("should filter by date range", async () => {
    ...
    // Assert
    expect(getWinRateData).toHaveBeenCalledWith(undefined, undefined, "2024-01-01", "2024-01-31");
  });
  ...
  it("should handle multiple filters", async () => {
    ...
    // Assert
    expect(getWinRateData).toHaveBeenCalledWith("Player1", "category1", "2024-01-01", "2024-01-31");
  });

...
describe("GET /api/analytics/activity", () => {
  ...
  it("should return activity data with date range", async () => {
    ...
    // Assert
    expect(status).toHaveBeenCalledWith(200);
    expect(getActivityData).toHaveBeenCalledWith(undefined, "2024-01-01", "2024-01-31", undefined);
  });
  ...
  it("should filter by player name", async () => {
    ...
    // Assert
    expect(getActivityData).toHaveBeenCalledWith("TestPlayer", undefined, undefined, undefined);
  });
  ...
  it("should filter by category", async () => {
    ...
    // Assert
    expect(getActivityData).toHaveBeenCalledWith(undefined, undefined, undefined, "category1");
  });

...
const { getEloHistory } = jest.requireMock(
...
describe("GET /api/analytics/elo-history", () => {
  ...
  it("should filter by player", async () => {
    ...
    // Assert
    expect(getEloHistory).toHaveBeenCalledWith("Player1", "category1", undefined, undefined);
  });
  ...
  it("should filter by category", async () => {
    ...
    // Assert
    expect(getEloHistory).toHaveBeenCalledWith("Player1", "category2", undefined, undefined);
  });
  ...
  it("should filter by date range", async () => {
    ...
    // Assert
    expect(getEloHistory).toHaveBeenCalledWith("Player1", "category1", "2024-01-01", "2024-01-31");
  });

...
export const UNKNOWN_ABILITIES: AbilityData[] = [
  ...
  },
  {
    ...
    description: "",
    tooltip:
      "Shapeshift into an animal form. Unlock following transformation :\n|cffFFD700Level 1 - Wolf\nLevel 2 - Bear\nLevel 3 - Panther\nLevel 4 - Tiger|r",
  ...
  },
  {
    ...
    description: "",
    tooltip:
      "The Troll Priest generates a friendly warming aura that spreads enveloping friendly units and envigorating them, adding |cffFE890D10%|r move speed, |cffFE890D5%|r attack speed, and heat.",
    areaOfEffect: 400,
    levels: {
      "1": {
        areaOfEffect: 400,

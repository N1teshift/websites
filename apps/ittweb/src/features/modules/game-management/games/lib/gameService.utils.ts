...
export function convertGameDoc(docData: Record<string, unknown>, id: string): Game {
  ...
  const baseGame: Game = {
    ...
    gameState,
    creatorName:
      typeof docData.creatorName === "string"
        ? docData.creatorName
        : String(docData.creatorName || ""),
    createdByDiscordId:
      typeof docData.createdByDiscordId === "string" ? docData.createdByDiscordId : undefined,
  ...
  if (gameState === "scheduled") {
    return {
      ...
      scheduledDateTime: docData.scheduledDateTime
        ? (docData.scheduledDateTime as Timestamp | string)
        : undefined,
      scheduledDateTimeString:
        typeof docData.scheduledDateTimeString === "string"
  ...
  const playerNames = Array.isArray(docData.playerNames)
    ...
    : undefined;
  const playerCount =
    typeof docData.playerCount === "number"
      ? docData.playerCount
      : playerNames
        ? playerNames.length
        : undefined;
  ...
  const completedGame: Game = {
    ...
    duration:
      typeof docData.duration === "number" ? docData.duration : Number(docData.duration) || 0,
    gamename:
      typeof docData.gamename === "string" ? docData.gamename : String(docData.gamename || ""),
    map: typeof docData.map === "string" ? docData.map : String(docData.map || ""),
    ownername:
      typeof docData.ownername === "string" ? docData.ownername : String(docData.ownername || ""),
    category: typeof docData.category === "string" ? docData.category : undefined,

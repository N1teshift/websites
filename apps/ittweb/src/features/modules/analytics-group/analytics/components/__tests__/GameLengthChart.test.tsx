...
describe("GameLengthChart", () => {
  ...
  it("should handle very short games", async () => {
    // Arrange
    const data: GameLengthDataPoint[] = [{ date: "2024-01-01", averageDuration: 0.5 }];
  ...
  it("should handle very long games", async () => {
    // Arrange
    const data: GameLengthDataPoint[] = [{ date: "2024-01-01", averageDuration: 300 }];
  ...
  it("should handle missing durations", () => {
    // Arrange
    const data: GameLengthDataPoint[] = [{ date: "2024-01-01", averageDuration: 0 }];
